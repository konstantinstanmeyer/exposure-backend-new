        ...
        <div className="absolute h-full w-full">
            <div className="mt-36 w-1/2 bg-neutral-700 h-1/2 mx-auto flex flex-row relative rounded-xl">
                <div className="w-1/3 bg-neutral-700 rounded-l-xl flex items-center flex-col relative">
                    <img className="w-2/3 rounded-full aspect-square object-cover bg-bottom mx-5 mt-auto" src={imageUrl ? imageUrl : "/profile.png"} />
                    <p className="w-fit mb-auto dangrek text-neutral-300 text-xl text-center">@{username}</p>
